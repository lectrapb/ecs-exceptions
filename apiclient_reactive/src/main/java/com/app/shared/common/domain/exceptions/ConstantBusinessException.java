...
public enum ConstantBusinessException implements ErrorManagement {
    ...
    MISSING_PARAMS_CODE_CID(HTTP_BAD_REQUEST,
            "Faltan datos requeridos",
            CodeMessage.INITIAL_CODE_DETAIL,
            "Valor CID no puede ser nulo para relacion",
            CodeLog.LOG404_00),

    MISSING_PARAMS_CODE_PRODUCT(HTTP_BAD_REQUEST,
            "Faltan datos requeridos",
            CodeMessage.INITIAL_CODE_DETAIL,
            "Valor de CODIGO DE PRODUCTO no puede ser nulo para relacion",
            CodeLog.LOG404_00);
    ...
    private static class CodeMessage {
        public static final String INITIAL_CODE_DETAIL = "Error de negocio";
    ...
    private static class InternalMessage {
        public static final String TECHNICAL_ERROR = "Error técnico Pendiente implementacion ECS";
