...
public enum ConstantBusinessException implements ErrorManagement {
    DEFAULT_EXCEPTION(HTTP_INTERNAL_ERROR,
        ...
        CodeLog.LOG500_00),
    BAD_REQUEST_EXCEPTION(HTTP_BAD_REQUEST,
        CodeMessage.MISSING_PARAMS_DETAIL,
        BusinessCode.MISSING_PARAMS_CODE,
        InternalMessage.BUSINESS_EXCEPTION,
        CodeLog.LOG400_00),
    CONFLICT_EXCEPTION(HTTP_CONFLICT,
        CodeMessage.INVALID_PARAMS_DETAIL,
        BusinessCode.INVALID_PARAMS_CODE,
        InternalMessage.BUSINESS_EXCEPTION,
        CodeLog.LOG409_00);
    ...
    private static class CodeMessage {
        ...
        public static final String INVALID_PARAMS_DETAIL = "Parámetros no validos";
    }
    ...
    private static class BusinessCode {
        ...
        public static final String INVALID_PARAMS_CODE = "ER409-00";
    }

    private static class CodeLog {
        public static final String LOG500_00 = "LOG500-000";
        public static final String LOG400_00 = "LOG400-000";
        public static final String LOG409_00 = "LOG409-000";
    }
